...
<body>
  <div class="layout">
    <aside class="sidebar">
      ...
      <nav class="nav">
        <a href="./high-admin-dashboard.html" style="color:#fff"><span>🏠</span><span>Dashboard</span></a>
        <a href="./high-admin.html" class="active" style="color:#fff"><span>👤</span><span>official Account</span></a>
      </nav>
    ...
    document.getElementById('createForm').addEventListener('submit', async (e) => {
      ...
      try{
        ...
        if(res.ok){
          ...
          if(body.errors){ const k = Object.keys(body.errors)[0]; errMsg = body.errors[k][0]; }
